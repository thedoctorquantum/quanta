...
pub const ImVector_ImWchar = struct_ImVector_ImWchar; // quanta/lib/cimgui/cimgui.h:1227:18: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiViewportP = struct_ImGuiViewportP; // quanta/lib/cimgui/cimgui.h:2658:15: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiTableDrawChannelIdx = ImU8; // quanta/lib/cimgui/cimgui.h:2817:10: warning: struct demoted to opaque type - has bitfield
...
pub const ImSpan_ImGuiTableCellData = struct_ImSpan_ImGuiTableCellData; // quanta/lib/cimgui/cimgui.h:2869:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiMetricsConfig = struct_ImGuiMetricsConfig; // quanta/lib/cimgui/cimgui.h:2246:19: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiStackTool = struct_ImGuiStackTool; // quanta/lib/cimgui/cimgui.h:2123:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiOnceUponAFrame = struct_ImGuiOnceUponAFrame; // quanta/lib/cimgui/cimgui.h:1040:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiSelectableFlags_NoSetKeyOwner: c_int = 268435456;
...
pub const ImGuiDebugLogFlags_EventIO: c_int = 32;
pub const ImGuiDebugLogFlags_EventDocking: c_int = 64;
pub const ImGuiDebugLogFlags_EventViewport: c_int = 128;
pub const ImGuiDebugLogFlags_EventMask_: c_int = 255;
...
pub const ImVector_ImGuiTableColumnSortSpecs = struct_ImVector_ImGuiTableColumnSortSpecs; // quanta/lib/cimgui/cimgui.h:2973:10: warning: struct demoted to opaque type - has bitfield
...
pub extern fn igTreeNodeV_Str(str_id: [*c]const u8, fmt: [*c]const u8, args: [*c]struct___va_list_tag) bool;
pub extern fn igTreeNodeV_Ptr(ptr_id: ?*const anyopaque, fmt: [*c]const u8, args: [*c]struct___va_list_tag) bool;
...
pub extern fn igTreeNodeExV_Str(str_id: [*c]const u8, flags: ImGuiTreeNodeFlags, fmt: [*c]const u8, args: [*c]struct___va_list_tag) bool;
pub extern fn igTreeNodeExV_Ptr(ptr_id: ?*const anyopaque, flags: ImGuiTreeNodeFlags, fmt: [*c]const u8, args: [*c]struct___va_list_tag) bool;
...
pub extern fn igLogTextV(fmt: [*c]const u8, args: [*c]struct___va_list_tag) void;
...
pub extern fn igImFormatStringToTempBufferV(out_buf: [*c][*c]const u8, out_buf_end: [*c][*c]const u8, fmt: [*c]const u8, args: [*c]struct___va_list_tag) void;
...
pub extern fn igGetKeyVector2d(pOut: [*c]ImVec2, key_left: ImGuiKey, key_right: ImGuiKey, key_up: ImGuiKey, key_down: ImGuiKey) void;
...
pub extern fn igGetKeyOwnerData(key: ImGuiKey) [*c]ImGuiKeyOwnerData;
...
pub extern fn igImageButtonEx(id: ImGuiID, texture_id: ImTextureID, size: ImVec2, uv0: ImVec2, uv1: ImVec2, bg_col: ImVec4, tint_col: ImVec4) bool;
...
pub extern fn igDebugLogV(fmt: [*c]const u8, args: [*c]struct___va_list_tag) void;
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdarg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdarg.h:18:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdarg.h:19:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdarg.h:24:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdarg.h:27:9
...
pub const API = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // quanta/lib/cimgui/cimgui.h:17:17
pub const EXTERN = @compileError("unable to translate C expr: unexpected token 'extern'"); // quanta/lib/cimgui/cimgui.h:28:13
pub const CONST = @compileError("unable to translate C expr: unexpected token 'const'"); // quanta/lib/cimgui/cimgui.h:32:9
