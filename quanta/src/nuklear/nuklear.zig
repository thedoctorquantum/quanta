...
pub const _dummy_array207 = [1]u8;
pub const _dummy_array208 = [1]u8;
pub const _dummy_array209 = [1]u8;
pub const _dummy_array210 = [1]u8;
pub const _dummy_array211 = [1]u8;
pub const _dummy_array212 = [1]u8;
pub const _dummy_array213 = [1]u8;
pub const _dummy_array214 = [1]u8;
pub const _dummy_array215 = [1]u8;
pub const _dummy_array219 = [1]u8;
...
pub const struct_nk_convert_config = extern struct {
    ...
    tex_null: struct_nk_draw_null_texture,
...
pub const nk_query_font_glyph_f = ?*const fn (nk_handle, f32, [*c]struct_nk_user_font_glyph, nk_rune, nk_rune) callconv(.C) void;
...
pub const struct_nk_style_button = extern struct {
    ...
    userdata: nk_handle,
    draw_begin: ?*const fn ([*c]struct_nk_command_buffer, nk_handle) callconv(.C) void,
    draw_end: ?*const fn ([*c]struct_nk_command_buffer, nk_handle) callconv(.C) void,
};
...
pub extern fn nk_plot_function([*c]struct_nk_context, enum_nk_chart_type, userdata: ?*anyopaque, value_getter: ?*const fn (?*anyopaque, c_int) callconv(.C) f32, count: c_int, offset: c_int) void;
...
pub extern fn nk_combo_callback([*c]struct_nk_context, item_getter: ?*const fn (?*anyopaque, c_int, [*c][*c]const u8) callconv(.C) void, userdata: ?*anyopaque, selected: c_int, count: c_int, item_height: c_int, size: struct_nk_vec2) c_int;
...
pub extern fn nk_combobox_callback([*c]struct_nk_context, item_getter: ?*const fn (?*anyopaque, c_int, [*c][*c]const u8) callconv(.C) void, ?*anyopaque, selected: [*c]c_int, count: c_int, item_height: c_int, size: struct_nk_vec2) void;
...
pub extern fn nk_input_has_mouse_click_in_button_rect([*c]const struct_nk_input, enum_nk_buttons, struct_nk_rect) nk_bool;
...
pub const NK_API = @compileError("unable to translate C expr: unexpected token 'extern'"); // quanta/lib/Nuklear/src/nuklear.h:43:13
pub const NK_LIB = @compileError("unable to translate C expr: unexpected token 'extern'"); // quanta/lib/Nuklear/src/nuklear.h:50:13
pub const NK_INTERN = @compileError("unable to translate C expr: unexpected token 'static'"); // quanta/lib/Nuklear/src/nuklear.h:54:9
pub const NK_STORAGE = @compileError("unable to translate C expr: unexpected token 'static'"); // quanta/lib/Nuklear/src/nuklear.h:55:9
pub const NK_GLOBAL = @compileError("unable to translate C expr: unexpected token 'static'"); // quanta/lib/Nuklear/src/nuklear.h:56:9
pub const NK_STRINGIFY = @compileError("unable to translate C expr: unexpected token '#'"); // quanta/lib/Nuklear/src/nuklear.h:59:9
pub const NK_STRING_JOIN_IMMEDIATE = @compileError("unable to translate C expr: unexpected token '##'"); // quanta/lib/Nuklear/src/nuklear.h:61:9
pub const NK_UNIQUE_NAME = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // quanta/lib/Nuklear/src/nuklear.h:68:11
pub const NK_STATIC_ASSERT = @compileError("unable to translate macro: undefined identifier `_dummy_array`"); // quanta/lib/Nuklear/src/nuklear.h:72:11
pub const NK_FILE_LINE = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // quanta/lib/Nuklear/src/nuklear.h:79:11
pub const __stdint_join3 = @compileError("unable to translate C expr: unexpected token '##'"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdint.h:245:9
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token '##'"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdint.h:282:9
pub const __uint_c = @compileError("unable to translate macro: undefined identifier `U`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdint.h:284:9
pub const __INTN_MIN = @compileError("unable to translate macro: undefined identifier `INT`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdint.h:776:10
pub const __INTN_MAX = @compileError("unable to translate macro: undefined identifier `INT`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdint.h:777:10
pub const __UINTN_MAX = @compileError("unable to translate macro: undefined identifier `UINT`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdint.h:778:9
pub const __INTN_C = @compileError("unable to translate macro: undefined identifier `INT`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdint.h:779:10
pub const __UINTN_C = @compileError("unable to translate macro: undefined identifier `UINT`"); // /home/zak/zig/0.11.0-dev.152+8a5818535/files/lib/include/stdint.h:780:9
pub const nk_foreach = @compileError("unable to translate C expr: unexpected token 'for'"); // quanta/lib/Nuklear/src/nuklear.h:1008:9
pub const nk_draw_foreach = @compileError("unable to translate C expr: unexpected token 'for'"); // quanta/lib/Nuklear/src/nuklear.h:1099:9
pub const nk_tree_push = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // quanta/lib/Nuklear/src/nuklear.h:2669:9
pub const nk_tree_image_push = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // quanta/lib/Nuklear/src/nuklear.h:2729:9
pub const nk_tree_element_push = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // quanta/lib/Nuklear/src/nuklear.h:2827:9
pub const nk_draw_list_foreach = @compileError("unable to translate C expr: unexpected token 'for'"); // quanta/lib/Nuklear/src/nuklear.h:4594:9
pub const NK_CONFIGURATION_STACK_TYPE = @compileError("unable to translate macro: undefined identifier `nk_config_stack_`"); // quanta/lib/Nuklear/src/nuklear.h:5324:9
pub const NK_CONFIG_STACK = @compileError("unable to translate macro: undefined identifier `nk_config_stack_`"); // quanta/lib/Nuklear/src/nuklear.h:5329:9
pub const NK_LEN = @compileError("unable to translate C expr: expected ')' instead got '['"); // quanta/lib/Nuklear/src/nuklear.h:5455:9
pub const nk_ptr_add = @compileError("unable to translate C expr: unexpected token ')'"); // quanta/lib/Nuklear/src/nuklear.h:5471:9
pub const nk_ptr_add_const = @compileError("unable to translate C expr: unexpected token 'const'"); // quanta/lib/Nuklear/src/nuklear.h:5472:9
pub const nk_zero_struct = @compileError("unable to translate macro: undefined identifier `nk_zero`"); // quanta/lib/Nuklear/src/nuklear.h:5473:9
pub const NK_OFFSETOF = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // quanta/lib/Nuklear/src/nuklear.h:5499:9
pub const NK_ALIGNOF = @compileError("unable to translate macro: undefined identifier `c`"); // quanta/lib/Nuklear/src/nuklear.h:5516:9
pub const NK_CONTAINER_OF = @compileError("unable to translate C expr: unexpected token ')'"); // quanta/lib/Nuklear/src/nuklear.h:5519:9
...
pub const NK_VERTEX_LAYOUT_END = blk: {
    _ = @TypeOf(NK_VERTEX_ATTRIBUTE_COUNT);
    _ = @TypeOf(NK_FORMAT_COUNT);
